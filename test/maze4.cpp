...
int lastError = 0;
float kp = 0.52;   //0.161  // Proportional gain - tune based on your bot
float kd = 2;    //0.8  // Derivative gain - tune based on your bot
...
void calibration()
{
  ...
  for (int i = 0; i <= 100; i++)
  {
    ...
    {
      right(motor1, motor2, 140);  // Right turn
    }
    qtra.calibrate();
    delay(10);
  }
